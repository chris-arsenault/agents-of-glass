...
Legacy scene framing is at `/home/dev/repos/agents-of-glass/campaigns/test-5/scene-framing.md`. Prefer the public table for immediate visible state.
...
Full transcript at `/home/dev/repos/agents-of-glass/campaigns/test-5/transcript.md`. Last few turns embedded for convenience. For older detail, use `glass search text`, `glass search semantic`, or `glass turns find --text` instead of asking another agent to repeat known history.
