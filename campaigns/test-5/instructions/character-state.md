...
culture, archetype, organization role, bio, and 2-3 goals. `glass character
mirror` writes the consistent public `players/<id>/public/character.md` display
from Postgres; do not hand-maintain that mirror.
...
Do not use `glass note write` to bypass signature move slot limits.
