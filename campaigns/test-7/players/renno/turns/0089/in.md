...
## SCENE OVERRUN (2 turn(s) past Final round)
...
- Tarot: you are currently under The Moon (Golden Dawn Room). Trust uncertainty without solving it. Let fear, dream logic, or mistaken shapes color perception. Look for hidden structure, element, threshold, and initiation.
...
Write your final public turn prose to **`players/renno/turns/0089/out.md`** and exit. Target 200-500 words for a normal full turn. Public prose is the creative summary of the visible story beat; use table, scene summary, messages, character state, notes, and the command audit for durable state. Full rules: `instructions/output-contract.md`.
...
- `players/renno/scratchpad.md` is optional current-turn working memory. For durable player-authored material, prefer `players/renno/public/`, `players/renno/secrets/`, `players/renno/notes/`, or `players/renno/journal/`.
