...
- Session: `test-7`
- Turn id: `test-7-t0010`
- Mode: **character-creation**
- Scene: **character-creation**

## Output contract

Write your final public turn prose to **`players/renno/turns/0010/out.md`** and exit. Full rules: `instructions/output-contract.md`.
