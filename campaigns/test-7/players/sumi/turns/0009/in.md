...
- Session: `test-7`
- Turn id: `test-7-t0009`
- Mode: **character-creation**
- Scene: **character-creation**

## Output contract

Write your final public turn prose to **`players/sumi/turns/0009/out.md`** and exit. Full rules: `instructions/output-contract.md`.
