...
- Session: `test-7`
- Turn id: `test-7-t0067`
- Mode: **scene-prep**
- Scene: **caulden-rack-setup**

## Output contract

Write your final public turn prose to **`dm/turns/0067/out.md`** and exit. Target 200-500 words for a normal full turn. Public prose is the creative summary of the visible story beat; use table, scene summary, messages, character state, notes, and the command audit for durable state. Full rules: `instructions/output-contract.md`.
...
- **Methodology for this mode:** [`methodologies/scene-prep.md`](methodologies/scene-prep.md). Read it before producing your turn — it tells you what to author, in what shape, with what constraints.
