...
Bioengineered by the elves during the ring era. Gnomes were designed — there is no polite way around the word — to interface with the orbital ring's resonance systems. Their biology incorporates ringglass at a fundamental level: crystalline structures threaded through their skeletal system and nervous tissue, grown in place rather than implanted. A gnome is, in a very literal sense, part crystal.
...
Their nervous system conducts resonance directly. A gnome can feel the local resonance landscape the way other species feel temperature — not as abstract data, but as immediate sensory experience. Warm and cold, loud and quiet, harmonic and dissonant. Walk a gnome into a room and they can tell you what ringglass is present, what frequencies are active, and whether anything is tuned wrong, before they've consciously registered any of it.
