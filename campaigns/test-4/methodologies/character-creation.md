...
Write public character prose under `players/<your-id>/public/` by using
`glass note write`. Add signature moves with `glass character bulk-update` or
...
The `archetype` field is a short string version of this — "Lapsed Tuner,"
"Sithari archivist on rotation," "Karet smith on the org payroll."
Descriptive, not categorical.

The `organization_role` field is separate: what this person does for the
party's organization. Examples: "route contact," "field medic," "resonance
reader," "witness handler," "quartermaster," "back-channel negotiator."
...
character leans on: a spell, combat maneuver, search style, social tactic,
chase technique, ritual, or other habit. This is not a guaranteed power or a
mechanical button. It is a consistency anchor the table can recognize, and the
DM can eventually let the world react to it.
...
The `organization_role` field names what this PC does for the org. Your intro's
Org Tie line explains how they got there and why they stay. Example:
`organization_role="uncertified resonance reader"` plus an Org Tie like
`"Tuning expertise the org can't get certified channels for; she joined after
the Conclave hearing barred her."`
...
glass character new <character-id> --player <your-agent-id> \
    ...
    --archetype "<short-string>" --org-role "<org function>" \
  ...
  "characters": [
    {
      ...
      "inventory_add": [
        {"id": "<signature-item-slug>", "qty": 1, "effect_tags": ["<specific story or use>"]},
        {"id": "<tool-slug>", "qty": 1},
...
Do not hand-author `players/<your-id>/public/character.md`. It is the canonical
public mirror generated by `glass character mirror`.
