---
title: Skills And Signature Moves
target: player-dm
...
Start with exactly three trained skills:

- one `artisan`
- two `apprentice`

Everything else defaults to `fool`. Do not start with `virtuoso`; the point of
...
- knowing Mereth's secret
- fixing this exact latch
- arguing with Duke Harl
- reading one page from one archive
...
signature move with a specific look and pressure use. The Glass Frontier's
magic is resonance: sound, vibration, harmonic force, ringglass response,
memory, signal, pressure, and pattern. It has room for dramatic, creative
answers, but the move still enters play through narration and rolls rather than
a fixed spell card.

Power should rise with slots. A level-1 move is low power: local, narrow,
costly, or conditional. Later slots can be broader, stronger, stranger, and
more scene-defining. As a rough D&D analogy, think of early moves like cantrip
or 1st-level spell permissions, and the fifth slot around level 9-10 like a
higher-level signature permission. This is only a scale reference, not a spell
slot system.
...
- **Close The Gate**: step into a doorway, gap, or cargo hatch with a baton,
  shield-cloth, or staff and hold it long enough for someone else to move.
- **Bell-Strike**: strike a tuned bell, brass horn, or resonance baton to break
  a charge, interrupt interference, or make a threat flinch.
- **Net The Shadow**: throw a weighted net or chalked line to constrain a target
  without trying to kill it.

Spell-like resonance examples:

- **Cinder Chord**: a Fireball-shaped move; clap, strike, or shout a compressed
  harmonic that blooms into heat, light, and pressure at a point.
- **Cutting Overtone**: a Cutting Words-shaped move; speak the bad note in
  someone's rhythm so their timing falters at the crucial moment.
- **Quiet Glass**: a Sanctuary-shaped move; wrap a person in a soft harmonic
  hush that makes violence hesitate or slide aside unless the attacker commits
  through it.
- **Glassward Snap**: a Shield-shaped move; snap a baton, bell, cuff, or ring
  shard into a hard one-breath resonance plane.
- **Still Note**: a Hold Person-shaped move; catch a target in a sustained tone
  that makes their body remember stillness.
- **Bell Push**: a Thunderwave-shaped move; ring a concussive chord outward to
  shove bodies, dust, doors, or loose cargo away.
- **Phase Skew**: a Misty Step-shaped move; slip a few paces through a bent
  resonance seam, arriving cold, ringing, or briefly out of phase.
- **Dissonance Break**: a Counterspell-shaped move; interrupt another resonance
  working by striking the clashing note before it resolves.

Weak examples:

- "Walks around the ship before flight." That is a tic or routine.
