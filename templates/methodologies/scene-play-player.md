...
3. Choose one clear action, answer, support move, or pass from the current scene board.
...
The same beat can take one more failed attempt before it closes, but the next attempt must be a concrete action that changes table position, not another layer of diagnosis or method explanation.
