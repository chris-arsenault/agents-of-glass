...
Goal: establish campaign planning state through MCP tools and plainly recorded
facts.

The opening arc follows the arc contract in `methodologies/arc-creation.md`: a
named antagonist with a goal, resources, and a next move; stakes that can be
lost for good; and a consequence that lands if the party does nothing. Plan
the arc from the antagonist outward, not from the party's job.
