---
title: Character-Branch Instructions Index
...
These files are binding mechanical instructions for active-play turns running
without player-persona surfaces.
...
- [`message-bus-character.md`](message-bus-character.md): message reads, sends,
  and recipient semantics for character-framed turns.
...
These instructions define agent operations for the character branch. They do
not replace the fiction, the SRD, or the selected methodology.
