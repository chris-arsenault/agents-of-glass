...
Human viewers of the web UI can inspect DM notes, lore, hooks, and
...
- a generated list of "active" entities
...
Do not infer table visibility from search rows or DM notes.
